...
<head>
    ...
    <title>@yield('title', 'Futsal Booking')</title>
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold text-green-600">FutsalKu</span>
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('home') }}" class="text-gray-700 hover:text-green-600 transition {{ request()->routeIs('home') ? 'text-green-600 font-semibold' : '' }}">
                        Beranda
                    </a>
                    <a href="{{ route('services') }}" class="text-gray-700 hover:text-green-600 transition {{ request()->routeIs('services') ? 'text-green-600 font-semibold' : '' }}">
                        Lapangan
                    </a>
                    
                    @auth
                        @if(auth()->user()->isAdmin())
                            <a href="{{ route('admin.dashboard') }}" class="text-gray-700 hover:text-green-600 transition">
                                Admin Panel
                            </a>
                        @else
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="flex items-center text-gray-700 hover:text-green-600 transition">
                                <div class="flex items-center">
                            ...
                            <div x-show="open" @click.away="open = false" 
                                ...
                                @else
                                    ...
                                    <a href="{{ route('my.bookings') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                                        Booking Saya
                                    </a>
                                @endif
    ...
    <footer class="bg-gray-900 text-white mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-lg font-bold mb-4">BookingApp</h3>
                    <p class="text-gray-400 text-sm">Sistem booking online yang mudah dan cepat untuk berbagai layanan.</p>
                </div>
                <div>
